                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row col-md-12 mb-4 justify-content-between">
                            <a href="{{route('post.habitants.create',$infrastructure)}}" class="btn btn-success">Nuevo habitante</a>
                            <a href="{{route('post.infrastructure.condition',$infrastructure)}}" class="btn btn-secondary">Evaluar post desastre</a>
                        </div>
                        ...
                        <table class="table table-bordered" id="habitants_table" style="width: 100%">
                            ...
                            @foreach($family_members as $family_member)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('post.habitants.edit', ['infrastructure'=> $infrastructure, 'habitant'=>$family_member])}}" class="btn btn-primary btn-sm">Editar</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
