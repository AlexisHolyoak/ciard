        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('queries.people.search')}}" method="post">
                            @csrf
                            Aqui podras consultar información general y especifica de las personas, para comenzar selecciona la ubicación de la(s) persona(s). Si deseas consultar masivamente por departamento, provincia, distrito, zona o espacio urbano selecciona uno de los checks según corresponda automaticamente podras consultar según tu selección.
                            <br>
                            ...
                            <h6>Ubicación de las personas:</h6>
