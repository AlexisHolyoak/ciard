                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('disasters.update',$disaster)}}" method="POST">
                            ...
                            <div class="form-group row" align="center">
                                <label for="urbanspace" class="col-md-4 col-form-label text-md-right">Espacios urbanos afectados</label>
                                <select id="urbanspace" name="urbanspace" class="form-control col-md-6"  disabled required></select>
    ...
    <script>
        ...
        $('#zone').change(function(e){
            ...
            $.get('/ajax-urbanspace/'+id, function(data){
                ...
                $('#urbanspace').selectpicker({
                    mobile :true
                });
                $('#urbanspace').selectpicker('refresh');
            });
